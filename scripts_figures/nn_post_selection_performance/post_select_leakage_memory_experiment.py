...
from lib.evaluation import get_ps_leakage_memory

# Parameters
EXP_NAMES = ["20250718_repcode_d3_exp_lru_v2", "20250718_repcode_d3_exp_no_lru_v2"]
TEST_DATASET = ["test"]
...
for exp_name in EXP_NAMES:
    ...
    for model_name in model_names:
        ...
        for test_dataset in TEST_DATASET:
            ...
            ps_leak = get_ps_leakage(config, test_dataset)
